(function(window) {
	...
	// =======================================================================
	// 
	// 				      Game Engine Constructor Function
	// 
	// ========================================================================
	function Engine() {
		var me = this;
	...
	Engine.prototype = {
		...
		getGameObjects: function() {
			...
			for (var x in this.gameObjects) {
				...
				copy_board[x] = this.gameObjects[x];
			}
			return copy_board;
		},
		...
		/**
		 * Draws the game board. Main render function - called on each turn.
		 * And after the start button is clicked!
		 */
		draw: function() {
			var c = this.ctx;
			...
			this.drawCells();
			// Draw all of the current pieces on the board
			this.drawObjects();
			// Draw a red square over the last move
			this.drawLastMove();
			// Draw a red line along the winning line
            this.drawWinnerLine();
		...
		drawCells: function() {
			...
			// Iterate through the number of vertical cells and draw rows
		...
		addGameObject: function(x, y, type) {
			...
			// TODO: Prevent overwritting other player's pieces??
		...
		/**
		 * Runs the game engine - Called when the start button is pressed.
		 */
		run: function() {
			// Reset the current game
			this.reset();
			// Draw all the default objects
			this.draw();
		...
		/**
		 * Resets the game - clear gameObjects, winnerline, and the board.
		 */
		reset: function() {
			this.gameObjects = {};
